...
** CF distribution with LP weights but in nominal terms
...
qui graph export ${path}\Figures\counterfactual_mw_${deflator}_nominal.pdf, as(pdf) replace
...
qui graph export ${path}\Figures\counterfactual_ns_${deflator}_nominal.pdf, as(pdf) replace 
